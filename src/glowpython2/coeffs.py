...
modglow_acoeff = [
    6.60e-6,  # 5200 N(4S-2D)
    6.44e-3,  # 6300 O(3P-1D)
    2.15e-3,  # 6364 O(3P-1D)
    0.0750,   # 2972 O(3P-1S)
    1.260,    # 5577 O(1D-1S)
    8.89e-5,  # 3726 O+(4S-2D)
    4.70e-2,  # 2470 O+(4S-2P)
    0.1740,   # 7319-30 O+(2D-2P) -> sum of 7320 and 7330
    8.89e-5,  # 0.660, # (Herzberg II) O2(X-c)
    0.3520,   # (Veg-Kap) N2(X-A)
    6.50e-3,  # 3466 N(4S-2P)
    3.45e-3,  # 10400 N(2D-2P)
]
...
modglow_bcoeff = [
    0.002,  # O(1S) from O2+ + e
    1.389,  # O(1D) from O2+ +, O2+ + e -> O(1D) + O(1D)
    0.76,   # N(2D) from NO+ + e
    1.12,   # N(2D) from N2+ + e, N2+ + e -> N(2D) + N(2D)
    1.0,    # N(2D) from N2+ + O, (1.0-0.07 tau_i^0.21)
    0.10,   # O(1D) from N(2D) + O2, Pavlov 2014
    0.10,   # O(1D) from O+(2D) + O, Pavlov 2014
    0.737,  # O+(2D) from O+(2P) + e
    0.100,  # O+(2P) from O + e*
    0.196,  # O+(2D) from O + e*
    0.283,  # O+(4S) from O + e*
    0.033,  # O+(2P) from O2 + e*
    0.065,  # O+(2D) from O2 + e*
    0.094,
    0.10,
    0.288,
    0.36,

...
! All units cgs.
  ...
  subroutine qback (zmaj,zno,zvcd,photoi,phono,f107,jm,nmaj,nst)
    ...
    real :: flyan ! photon flux at 121.6 nm
    real :: tau, qbo1, qbo2, qbn2, qbn1, qbno

    data al /1.5e7, 1.5e6, 1.5e6/ ! photon flux at 102.6 nm, 58.4 nm, 30.4 nm
    data sa /      0.,  1.6e-18,       0., & ! absorption cross sections for O,
             10.2e-18, 22.0e-18, 23.1e-18, & ! absorption cross sections for O2,
              8.4e-18, 16.0e-18, 11.6e-18/   ! absorption cross sections for N2
    data si /      0.,  1.0e-18,       0., & ! ionization cross sections for O,
             10.2e-18, 22.0e-18, 23.1e-18, & ! ionization cross sections for O2,
              8.4e-18, 16.0e-18, 11.6e-18/   ! ionization cross sections for N2
    data salyao2/8.0e-21/ ! absorption cross section for O2 at 121.6 nm
    data silyano/2.0e-18/ ! ionization cross section for NO at 121.6 nm
    data bn2p/0.86/ ! branching ratio for N2+ from ionization of N2
    data bn1p/0.14/ ! branching ratio for N+ from ionization of N2

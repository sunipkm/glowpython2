...
C
C
      SUBROUTINE IGRFINIT(CONSOL,MESSAGE)
C INITIALIZATION OF COMMON/IOUNIT/ FOR IGRF ROUTINES
      IMPLICIT NONE
      COMMON /CONST/UMR,PI
     &  /IGRF1/ERA,AQUAD,BQUAD,DIMO
     &  /findRLAT/FLON,RYEAR
     &  /iounit/konsol,mess
      INTEGER KONSOL, CONSOL
      LOGICAL MESSAGE, MESS
      REAL UMR,PI,ERA,AQUAD,BQUAD,DIMO,FLON,RYEAR
      REAL EREQU,ERPOL,EEXC
      pi=ATAN(1.0)*4.
      UMR=pi/180.
      ERA=6371.2
      EREQU=6378.16
